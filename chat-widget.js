...
(function() {
    ...
    const styles = `
        ...
        .n8n-chat-widget .brand-header {
            ...
            position: relative;
            background: var(--n8n-chat-header-background-color, #f0f0f0);
        }
    ...
    const defaultConfig = {
        ...
        branding: {
            ...
            responseTimeText: '',
            poweredBy: {
                text: 'Powered by RB Improve',
                link: 'https://rbimprove.com'
            }
        },
        style: {
            primaryColor: '',
    ...
    const chatInterfaceHTML = `
        <div class="chat-interface">
            ...
            <div class="chat-input">
                <textarea placeholder="Escriu el teu missatge..." rows="1"></textarea>
